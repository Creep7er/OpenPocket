...
OpenPocket 0.4.0 has no accounts, analytics, advertising identifiers, telemetry, or cloud synchronization.
...
- OpenPocket does not upload the installed cartridge list; update comparison is local.
