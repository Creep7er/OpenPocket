...
SDK 0.3.2 is experimental. Cartridge services are `PocketInput`, `PocketStorage`, `CartridgeAudio`, `PocketSystem`, and `PocketTheme`. `PocketAudio` owns Shell UI sound. External GDScript is not sandboxed or signed.
