...
const PACKAGE_ID := "org.example.app"
...
func _draw() -> void:
	...
	PixelFont.draw_text(self, Vector2(24, 48), "EXAMPLE APP", p["hi"], 2)
	PixelFont.draw_text(self, Vector2(24, 92), "LOCAL DATA VIA POCKETSTORAGE", p["light"], 1)
